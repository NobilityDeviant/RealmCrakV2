...
public class Proxy {
     ...
     * @return Proxy - current Proxy object
     */
    public Proxy setProxyType(ProxyType type) {
        this.type = type;
        return this;
    }

    public Proxy setProxyTypeValue(java.net.Proxy.Type typeValue) {
        switch (typeValue) {
            case HTTP:
            default:
    ...
    public java.net.Proxy.Type getTypeFromValue() {
        switch (type) {
            case SOCKS:
